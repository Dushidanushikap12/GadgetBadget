  ...
  <div id="main">
    <div id="header">
      ...
      <div id="menubar">
        <ul id="menu">
          ...
          <li class="selected"><a href="AddProduct.jsp">Add Product</a></li>
    ...
    <div id="site_content">
      ...
      <div>
       ...
       <div class="container">
	    <h3>Add Products To Database</h3>
	   <form id="formItem"  name="formItem">
		   ...
		   <div style="width: 48%; float:left ">
			...
			<div style="width: 48%; float:right">
					...
					<input id="btnSave" name="btnSave" type="button" value="Save Product"class="btn btn-primary">
